    ...
    >
      ...
      <div className="col-md-8">
        ...
        {pool.bets.length > 0 &&
          pool.bets.some(
            ...
            <p className="yellow small-text text-wrap">
              You have made a play in this Pool!
            </p>
          )}
        ...
        <div className="row">
          ...
          <div className="col-md-3 col-6">
            <TutorialPopup content="Max cap - the maximum play size which this pool can accept from all players">
              <p className="grey small-text mb-0">Max cap</p>
            </TutorialPopup>
            <p className="bold small-text yellow">
              {roundNumber(pool.maxCap || 0)} FZL
            </p>
          </div>
          <div className="col-md-3 col-6">
            <TutorialPopup content="Pool size - the total play currently placed by all players">
              <p className="grey small-text mb-0">Pool size</p>
            </TutorialPopup>
            <p className="bold small-text yellow">
              {roundNumber(pool.total || 0)} FZL
            </p>
          </div>
          <div className="col-md-3 col-6">
