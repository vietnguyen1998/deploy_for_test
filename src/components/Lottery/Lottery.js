      ...
      <div style={{ backgroundColor: "#021025" }}>
        ...
        >
          ...
          <div className=" d-flex justify-content-center">
            <h1 className="yellow">Fuzanglong Lucky Seven Lottery</h1>
          </div>
          <div className=" d-flex justify-content-center">
            <h1 className="red bold">2,000,000 FZL </h1>
          </div>
          <br />
          <div className=" d-flex justify-content-center">
          ...
          <div className="row d-flex justify-content-around mt-2">
            <div className="col-3 step">
              ...
              <p className="white" align="center">
                Each ticket costs only 1 FZL, buy more tickets to inscease your
                chances of winning!
              </p>
            </div>
            <div className="col-3 step">
          ...
          <div className="row">
            <div className="col-8">
              <p className="bright-grey" align="justify">
                Stake FZL in Lucky 7's Lottery pool to earn lottery profits!
          ...
          <div>
            ...
            <div class="collapse" id="collapsePrizeStructure">
              <p className="bright-grey" align="justify">
                The prize pool is a fixed at 2million FZL for each draw. It is
                divided according to the following:
              </p>
              <p className="bright-grey" align="justify">
                1st prize - 40% (800K FZL) is divided equally among all tickets
                that match all 7 digits in the exact order
              </p>
              <p className="bright-grey" align="justify">
                2nd prize - 25% (500K FZL) is divided equally among all tickets
                that match the first 6 digits of the winning number, in the
                exact order
              </p>
              <p className="bright-grey" align="justify">
                3rd Prize - 15% (300K FZL) is divided equally among all tickets
                that match the first 5 digits of the winning number, in the
                exact order
              </p>
              <p className="bright-grey" align="justify">
                Match4 - 10% (200K FZL) is divided equally among all tickets
                that match the first 4 digits of the winning number, in the
                exact order
              </p>
              <p className="bright-grey" align="justify">
                Match3 - 5% (100K FZL) is divided equally among all tickets that
                match the first 3 digits of the winning number, in the exact
                order{" "}
              </p>
              <p className="bright-grey" align="justify">
                Match2 - 3% (60K FZL) is divded equally among all tickets that
              ...
              <p className="bright-grey" align="justify">
                Match1 - 2% (40K FZL) is divided equally among all tickets that
