      ...
      >
        ...
        <div className="row mt-4">
          ...
          <div className="col text-center">
            ...
            <p className="yellow">{currentLottery.totalPrize} FZL</p>
          </div>
          <div className="col text-center">
            <p className="white">Pool Size</p>
            <p className="yellow">{totalPoolSize} FZL</p>
          </div>
          <div className="col text-center">
        ...
        <div className="row mt-2">
          <div className="col">
            <Tabs defaultIndex={tabIndex}>
              ...
              <TabPanel>
                ...
                <div className="row" style={{ marginLeft: "1%" }}>
                  ...
                  <div className="col-6">
                    ...
                    >
                      {approvedTicketBatch ? "Purchase batch" : "Approve FZL"}
                    </button>
                  </div>
                  {/* </div> */}
                </div>
              ...
              <TabPanel>
                <div className="row">
                  <p className="white ml-3">Current stake: {userStake} FZL</p>
                </div>
                <div className="row">
                  <div className="col">
                ...
                <div className="row">
                  ...
                  <div className="col-3">
                    ...
                    >
                      {approvedStake ? "Stake" : "Approve FZL"}
                    </button>
                  </div>
                  <div className="col-3">
